                  ...
                  <CenterVerticalContainer>
                    {
                      (account !== null && account !== undefined) ? (
                        <Row>
                          <Button size='sm' variant='secondary' onClick={openDepositModal}>Deposit</Button>
                          {
                            baseData !== undefined && norValue(baseData?.balanceOf, token?.decimals) > 0 ? (
                              <Button size='sm' variant='secondary' className="ml-2" onClick={openWithdrawModal}>Withdraw</Button>
                            ) : (
                              <Button size='sm' variant='secondary' className="ml-2" disabled>Withdraw</Button>
                            )
                          }
                        </Row>
                      ) : (
                        <Row>
                          <Button size='sm' variant='secondary' disabled>Deposit</Button>
                          <Button size='sm' variant='secondary' className="ml-2" disabled>Withdraw</Button>
                        </Row>
                      )
                    }
                ...
                <CenterContainer>
                  {
                    stakeOpened ?
                      ...
                      : account !== null && account !== undefined && baseData !== undefined ?
                        <Button size='sm' variant='secondary' onClick={open}>Stake<ChevronDownIcon /></Button> :
                        <Button size='sm' disabled>Stake<ChevronDownIcon style={{ fill: "#666171" }} /></Button>
                  }
                </CenterContainer>
              </Col>
            </Row>
