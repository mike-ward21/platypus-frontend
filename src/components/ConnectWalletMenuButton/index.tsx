...
`
  ...
  return (
    <div>
      {!account ?
        (<Button style={buttonStyle} variant="primary" size="sm" onClick={onPresentConnectModal} {...props}>
          <EllipsisButtonText>Connect</EllipsisButtonText>
        </Button>) 
        : 
        (<Button style={buttonStyle} size="sm" variant="primary" onClick={onPresentAccountModal} {...props}>          
