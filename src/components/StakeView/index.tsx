          ...
          <Col md={4} xs={12} style={verticalCenterContainerStyle}>
            {
              radio === 'claim' ? (
                claimableAmount > 0 ? (
                  <Button  fullWidth onClick={handleClaimPTP}>Claim</Button>
                ) : (
                  <Button  disabled fullWidth>Claim</Button>
                )
              ) : (
                radio === 'stake' ? (
                  <div>
                    <Text fontSize='10px'>Earned PTP will be automatically claimed on staking</Text>
                    {
                      stakableAmount > 0.000001 ? (
                        <Button  fullWidth onClick={openLPStakeModal}>Stake All</Button>
                      ) : (
                        <Button  disabled fullWidth>Stake All</Button>
                      )
                    }
                  </div>
                ) : (
                  <div>
                    <Text fontSize='10px'>Earned PTP will be automatically claimed on unstaking</Text>
                    {
                      stakedAmount > 0.000001 ? (
                        <Button  fullWidth onClick={openLPUnStakeModal}>Unstake All</Button>
                      ) : (
                        <Button  disabled fullWidth>Unstake All</Button>
                      )
                    }
                  </div>
                )
