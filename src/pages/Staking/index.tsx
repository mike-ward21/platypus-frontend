    ...
    <>
      ...
      <MaxWidthDiv>
        <LightCard className="mt-2 p-3">
          ...
          <div className="mt-4" >
            <div style={{ width: '100%', height: '1px', backgroundColor: theme.colors.textSubtle, position: 'relative', top: '13px' }} />
            <div style={{ display: 'flex', justifyContent: 'center', position: 'relative' }}>
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', backgroundColor: '#0a0e17', paddingLeft: '10px', paddingRight: '10px' }}>
                ...
                {
                  account ?
                    <Text className='textBtn' style={{ color: theme.colors.textSubtle, cursor: 'pointer' }} onClick={openCalcModal}>Booster Calculator</Text> :
                    <Text className='textBtn' style={{ color: theme.colors.textSubtle, cursor: 'pointer' }} >Booster Calculator</Text>
                }
                <Text>)</Text>
              </div>
            </div>
