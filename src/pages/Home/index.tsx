  ...
  return (
    <>
      ...
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <Text style={{ transitionDelay: '2s, 4ms', fontSize: '45px', color: theme.colors.textSubtle  }}>A whole new kind of AMM for stableswap</Text>
        </div>
        <div style={{ display: 'flex', justifyContent: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '50px' }}>
          <Link to='/swap'>
            <RoundEdgeBtn
              ...
              hoverBorderColor={ theme.colors.textSubtle}
              hoverColor={ theme.colors.textSubtle}
              hoverBackgroundColor={theme.button.secondary.background}
            >
              Launch App
            </RoundEdgeBtn>
          </Link>
          <RoundEdgeBtn
            ...
            backgroundColor={theme.button.secondary.background}
            borderWidth='3px'
            borderColor={theme.button.secondary.color}
            fontSize='20px'
            fontWeight='semi-bold'
            color={theme.button.secondary.color}
            hoverBorderColor={theme.button.secondary.color}
            hoverColor={theme.button.secondary.color}
            hoverBackgroundColor={theme.button.secondary.background}
          >
            Join Community
          </RoundEdgeBtn>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '250px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle }}>The Current Problems of Other Stableswaps</Text>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '250px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle }}>Thoughtfully Crafted</Text>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '150px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle, marginTop: '100px' }}>Investors</Text>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '250px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle }}>Audits</Text>
        </div>
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '70px', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '150px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle, marginTop: '100px' }}>Roadmap</Text>
        </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '150px' }}>
          <Text style={{ fontSize: '50px', color: theme.colors.textSubtle, marginTop: '100px' }}>Join Our Community</Text>
        </div>
